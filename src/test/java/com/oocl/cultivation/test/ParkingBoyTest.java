...
public class ParkingBoyTest {
    ...
    @Test
    void should_park_to_second_parkingLot_when_cars_is_full_frist_parkingLot_capacity_give_12_cars() {
        // given
        ...
        // then
        assertEquals(1, parkingBoy.getParkingLot().getCarTicketCarMap().size());
    }
